    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                <h1 class="page-header">Redaguoti produktą</h1>
                        ...
                        <div class="panel-body">
                            <form action="{{ route('admin.edit.product', ['id' => $product->id]) }}" method="POST">
                                <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title" placeholder="Prekės pavadinimas" value="{{ $product->title }}">
                                    @if($errors->has('title'))
                                ...
                                <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" id="image" name="image" placeholder="http://www.img.com/54aaqfh9" value="{{ $product->image }}">
                                    @if($errors->has('image'))
                                ...
                                <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" id="price" name="price" placeholder="49.99" value="{{ $product->price }}">
                                    @if($errors->has('price'))
                                ...
                                <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                    ...
                                    <textarea rows="3" cels="9" class="form-control" id="description" name="description" placeholder="Trumpas aprašymas apie prekę">{{ $product->description }}</textarea>
