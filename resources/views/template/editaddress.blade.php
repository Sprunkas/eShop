            ...
            <div class="row">
                <div class="col-lg-9 col-md-9 col-sm-7">
                    ...
                    <div class="row">
                        ...
                        <form action="{{ route('profile.edit.address', ['id' => $address->id]) }}" method="POST">
                            <div class="col-xs-12 col-sm-6">
                                <div class="form-group required">
                                    <label for="first_name">Vardas <sup>*</sup> </label>
                                    <input required type="text" class="form-control" name="first_name" id="first_name" placeholder="Vardas" value="{{ $address->first_name }}">
                                </div>
                                <div class="form-group required">
                                    <label for="last_name">Pavardė <sup>*</sup> </label>
                                    <input required type="text" class="form-control" name="last_name" id="last_name" placeholder="Pavardė" value="{{ $address->last_name }}">
                                </div>
                                <div class="form-group required">
                                    <label for="address">Adresas <sup>*</sup> </label>
                                    <input required type="text" class="form-control" name="address" id="address" placeholder="Adresas" value="{{ $address->address }}">
                                </div>
                                <div class="form-group required">
                                    <label for="city">Miestas <sup>*</sup> </label>
                                    <input required type="text" class="form-control" name="city" id="city" placeholder="Vilnius" value="{{ $address->city }}">
                                </div>
                                <div class="form-group required">
                                    <label for="postal_code">Pašto kodas</label>
                                    <input type="text" class="form-control" name="postal_code" id="postal_code" placeholder="Pašto kodas" value="{{ $address->postal_code }}">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6">
                                <div class="form-group">
                                    <label for="additional_info">Papildoma informacija</label>
                                    <textarea rows="3" cols="26" name="additional_info" id="additional_info" class="form-control">{{ $address->additional_info }}</textarea>
                                </div>
                                <div class="form-group required">
                                    <label for="phone_number">Telefono numeris <sup>*</sup></label>
                                    <input required type="text" name="phone_number" id="phone_number" class="form-control" value="{{ $address->phone_number }}">
                                </div>
                                <div class="form-group required">
                                    <label for="title">Pavadinimas, kaip vadinsis ši forma. <sup>*</sup></label>
                                    <input required type="text" name="title" id="title" class="form-control" placeholder="Adresas #1" value="{{ $address->title }}">
                                </div>
                            </div>
