                    ...
                    <form action="{{ route('profile.settings') }}" method="POST">
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-group required">
                                ...
                                <input required type="text" class="form-control" name="first_name" placeholder="Vardas" value="{{ $settings->first_name }}">
                            </div>
                            <div class="form-group required">
                                <label for="last_name">Pavardė <sup>*</sup> </label>
                                <input required type="text" class="form-control" name="last_name" placeholder="Pavardė" value="{{ $settings->last_name }}">
                            </div>
                            <div class="form-group required">
                                <label for="email">El. paštas <sup>*</sup></label>
                                <input required type="email" class="form-control" name="email" placeholder="el.pastas@mail.lt" value="{{ $settings->email }}">
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-group required">
