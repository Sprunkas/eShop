                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12">
                            <h1 class=" text-left border-title">Terminai ir sąlygos</h1>
                            <p>
                                <strong>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus nec fringilla diam. Quisque sed
                                sagittis sem. Nulla ultrices tortor eu ligula pulvinar rutrum</strong>
                            </p>
                            <p> 
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus nec fringilla diam. Quisque sed
                            ...
                            <div class="w100 clearfix">
                                <h3>Įžanga</h3>
                                <p> 
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus risus nisl, fringilla
                                    ...
                                    pellentesque tempor, diam risus mollis massa, ac adipiscing orci diam egestas eros. 
                                </p>
                                <hr>
                                <h3>Paskyra, bei saugumas: </h3>
                                <p> 
                                    Vivamus luctus egestas convallis. Vestibulum arcu sapien, consequat a urna a, gravida
                                    ...
                                    metus ac sollicitudin. 
                                </p>
                                <hr>
                                <h3>Privatumo politika: </h3>
                                <p> 
                                    Duis eu massa diam. Donec in porta tortor, in pharetra velit. Nunc at justo convallis,
                                    ...
                                    diam, sit amet condimentum ligula pellentesque a. 
                                </p>
                                <hr>
                                <h3>Nuostatos ir taisyklės: </h3>
                                <p> 
                                    Donec sit amet convallis est. Morbi molestie, est sed viverra vehicula, ligula sem egestas
                                ...
                                <h3>Siuntimas: </h3>
                                <p> 
                                    Etiam tempus sodales luctus. Nam mattis ipsum id magna sollicitudin, et ullamcorper neque
                                    ...
                                    dapibus sed. Sed libero ligula, ultricies non pharetra at, ullamcorper sed quam. 
                                </p>
                                <hr>
                                <h3>Pardavėjas: </h3>
                                <p> 
                                    sit amet condimentum massa turpis vel nisl. Suspendisse lobortis lorem mollis, sodales magna
                                    ...
                                    pharetra at, ullamcorper sed quam. 
                                </p>
                                <hr>
                                <h3>Pirkėjas: </h3>
                                <ul class="list-dot">
